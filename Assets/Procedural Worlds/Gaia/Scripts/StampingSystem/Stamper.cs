...
#region Unity Related Methods
        ...
        public void UpdateTerrainLoader()
        {
            ...
            if (m_loadTerrainMode != LoadMode.Disabled)
            {
                ...
                TerrainLoader.m_loadingBounds = new BoundsDouble(center, new Vector3(width, height, width));
            }
...
//        }
        ...
        void DrawGizmos(bool isSelected)
        {
            ...
            if (m_showBoundingBox)
            {
                ...
                //Clamp the yPos between the bottom of the terrain and the highest possible point
                ...
                bounds.size = new Vector3(activeTerrain.terrainData.size.x / 100f, activeTerrain.terrainData.size.y / m_settings.m_height, activeTerrain.terrainData.size.x / 100f);
            ...
            if (m_stampDirty || m_cachedRenderTexture == null)
            {
                ...
                switch (m_settings.m_operation)
                {
                    case GaiaConstants.FeatureOperation.HydraulicErosion:
                        ...
                        //ImageProcessing.WriteRenderTexture("D:\\ErosionInputHeight.png", m_Eroder.inputTextures["Height"]);
                        ...
                        //Graphics.Blit(m_Eroder.outputTextures["Height"], outputTexture);
